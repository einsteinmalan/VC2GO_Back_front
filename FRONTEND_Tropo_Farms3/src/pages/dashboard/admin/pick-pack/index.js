...
const PickAndPack = () => {
    ...
    return (
        <AppLayout
            ...
            <Head>
                <title>Volta Catch - Pick & Pack</title>
            </Head>
                                                        ...
                                                        <div className="w-1/5 px-2">
                                                            <div className=" inline-block text-left w-auto ">
                                                                `  <button type="button"
                                                                           ...
                                                                           onClick={()=>{
                                                                               setTimeout(() => {
                                                                                   router.push("/dashboard/admin/pick-pack/pick-list");
                                                                               }, 1000);
                                                                    ...
                                                                    <tr  key={user.id} className='pl-1'>
                                                                        ...
                                                                        <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                                                            <p className="text-gray-900 px-3 min-w-140-px">
                                                                                <select
                                                                                    className="block w-full text-gray-700  border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-gray-500 focus:border-gray-500"
                                                                                    name="status_type">
                                                                                    <option value="none">
                                                                                        Assign Driver
                                                                                    </option>
