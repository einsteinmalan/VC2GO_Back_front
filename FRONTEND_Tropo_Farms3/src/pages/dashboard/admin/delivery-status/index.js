...
export  const getStaticProps = async ()=> {
    const res = await   fetch(`${linkBaseUrl}/api/delivery-status`);
    const  data = await  res.json();

    return {
        props: { allStatus: data}
    };
}



const DeliveryStatussPage = ({allStatus}) => {
                                                        ...
                                                        <div className="relative inline-block text-left w-auto  mr-4">
                                                            <button type="button"
                                                                    ...
                                                                    onClick={()=>{
                                                                        ...
                                                                        setTimeout(() => {
                                                                            router.push("/dashboard/admin/delivery-status/create");
                                                                        }, 300);
                                                                    }}
                                                            >
                                                                Add Delivery Status
...

                                                                {
                                                                    ...
                                                                    data.map((item)=>(
                                                                        <tr key={item.id}>
                                                                            ...
                                                                            <td className="px-4 py-5 w-22-px h-22-px border-b border-gray-200 bg-white text-sm">
                                                                                <div style={{backgroundColor: item.color, height:40,width:50}}>
                                                                                    <div className="">
...
export default DeliveryStatussPage
