...
const PriceList = () => {
    ...
    return (
        <AppLayout
            ...
            <Head>
                <title>Volta Catch - Drivers</title>
            </Head>
                                                            ...
                                                            <div className=" inline-block text-left w-auto ">
                                                                `  <button type="button"
                                                                           ...
                                                                           onClick={()=>{
                                                                               ...
                                                                               setTimeout(() => {
                                                                                   router.push("/dashboard/admin/driver-management/create");
                                                                               }, 1000);
                                                                           }}
                                                            >
                                                                Add Driver
