...
const ShipppingType = () => {
    ...
    return (
        <AppLayout
            ...
            <Head>
                <title>Volta Catch - Shipping Types</title>
            </Head>
                                                            ...
                                                            <div className=" inline-block text-left w-auto ">
                                                                `  <button type="button"
                                                                           ...
                                                                           onClick={()=>{
                                                                               ...
                                                                               setTimeout(() => {
                                                                                   router.push("/dashboard/admin/shipping-type/create");
                                                                               }, 1000);
                                                                           }}
                                                            >
                                                                Add Shipping Types
                                                            ...
                                                            <div className=" inline-block text-left w-auto ">
                                                                `  <button type="button"
                                                                           ...
                                                                           onClick={()=>{
                                                                               ...
                                                                               setTimeout(() => {
                                                                                   router.push("/dashboard/admin/shipping-type/shipping-rate");
                                                                               }, 1000);
                                                                           }}
                                                            >
                                                                View Shipping Rates
