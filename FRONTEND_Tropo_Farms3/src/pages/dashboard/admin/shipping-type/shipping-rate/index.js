...
const ShipppingRates = () => {
    ...
    const list = [
        ...
        {
            'id':2,
            'shipping_type': 'Cold Fridge Truck',
            'location': 'MT-SALES',
            'base_unit_price': 1,
            'created': '02/04/2022',
            'status': 'active'
                                                ...
                                                <div className="py-8">
                                                    ...
                                                    <div className="flex flex-row mt-5">
                                                        ...
                                                        <div className="w-1/5">
                                                            ...
                                                            <div className=" inline-block text-left w-auto ">
                                                                `  <button type="button"
                                                                           className="border border-gray-300 bg-gray-100 shadow-sm hover:-bg-blue-500 hover:text-white justify-center rounded-md  px-12 py-2 text-sm font-medium text-gray-900 dark:text-gray-50 hover:bg-gray-50  focus:outline-none"
                                                                           id="options-menu"
                                                                           onClick={()=>{


                                                                               setTimeout(() => {
                                                                                   router.push("/dashboard/admin/shipping-type/shipping-rate/create");
                                                                               }, 1000);
                                                                ...
                                                                {list.length >0 && list.map((user)=>(
                                                                    ...
                                                                    <tr  key={user.id} className='pl-1'>
                                                                        ...
                                                                        <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                                                            ...
                                                                            <Link href={'/dashboard/admin/driver-management/view/'+ user.id}>
