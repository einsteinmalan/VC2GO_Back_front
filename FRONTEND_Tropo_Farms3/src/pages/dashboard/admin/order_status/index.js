...
export  const getStaticProps = async ()=> {
    const res = await   fetch(`${linkBaseUrl}/api/order-status`);
...
const OrderStatussPage = ({allStatus}) => {
    ...
    return (
        <AppLayout
            ...
            <Head>
                <title>Volta Catch - Order Status</title>
            </Head>
                                                        ...
                                                        <div className="relative inline-block text-left w-auto  mr-4">
                                                            <button type="button"
                                                                    ...
                                                                    onClick={()=>{
                                                                        ...
                                                                        setTimeout(() => {
                                                                            router.push("/dashboard/admin/order_status/create");
                                                                        }, 300);
                                                                    }}
                                                            >
                                                                Add Order Status
