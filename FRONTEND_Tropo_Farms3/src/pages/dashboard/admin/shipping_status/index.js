...
export  const getStaticProps = async ()=> {
    const res = await   fetch(`${linkBaseUrl}/api/shipping-status`);
...
const ShippingStatussPage = ({allStatus}) => {
                                                        ...
                                                        <div className="relative inline-block text-left w-auto  mr-4">
                                                            <button type="button"
                                                                    ...
                                                                    onClick={()=>{
                                                                        ...
                                                                        setTimeout(() => {
                                                                            router.push("/dashboard/admin/shipping_status/create");
                                                                        }, 300);
                                                                    }}
                                                            >
                                                                Add Shipping Status
...
export default ShippingStatussPage
