...
const CreateShippStatusPage = () => {
    ...
    const submitData = async (ev) => {
        ...
        setLoading(true);
        const rawResponse = await fetch(`${linkBaseUrl}/api/shipping-status`, {
            method: 'POST',
            headers: {
        ...
        if(content !== null && content !== undefined){
            ...
            setLoading(false);
            setTimeout(() => {
                router.push("/dashboard/admin/shipping_status/");
            }, 300);
...
export default CreateShippStatusPage
