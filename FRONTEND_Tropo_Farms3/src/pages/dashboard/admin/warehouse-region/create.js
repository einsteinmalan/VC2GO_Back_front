...
const CreateWarehouseRegionPage = () => {
    ...
    const submitData = async (ev) => {
        ev.preventDefault();
        setLoading(true);
        const rawResponse = await fetch(`${linkBaseUrl}/api/location`, {
            method: 'POST',
            headers: {
    ...
    return (
        <AppLayout
            ...
            <Head>
                <title>Volta Catch - Region</title>
            </Head>
...
export default CreateWarehouseRegionPage
