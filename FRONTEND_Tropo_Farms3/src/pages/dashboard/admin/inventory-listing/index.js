        ...
        <AppLayout
            header={
                <h2 className="font-semibold text-xl text-gray-800 leading-tight">
                    All Inventory Listing
                </h2>
            }>

            <Head>
                <title>Volta Catch - Inventory Listing</title>
            </Head>
                                                            ...
                                                            <div className=" inline-block text-left w-auto ">
                                                                `  <button type="button"
                                                                           ...
                                                                           onClick={()=>{
                                                                               ...
                                                                               setTimeout(() => {
                                                                                   router.push("/dashboard/admin/inventory-listing/create");
                                                                               }, 1000);
                                                                           }}
                                                            >
                                                                Add New Item
                                        ...
                                        <span className={user.status ==='active'? 'relative bg-green-light p-2  rounded text-white' : "relative bg-red-500 p-2  rounded text-white"}>
                                             {user.status ==='active'? 'Active' : 'NOT ACTIVE' }
                                                                        ...
                                                                        <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                                                            ...
                                                                            <Link href={'/dashboard/admin/inventory-listing/view/'+ user.id}>
