...
export default function TicketSuccessful() {
    const [open, setOpen] = useState(true)
    const router = useRouter();

    return (
        <Transition.Root show={open} as={Fragment}>
            <Dialog as="div" className="fixed  top-210-px  left-360-px overflow-y-auto" onClose={setOpen}>
                                ...
                                <div className="mt-3 text-center sm:mt-5">
                                    ...
                                    <div className="mt-2">
                                        <p className="text-sm text-gray-500">
                                            Your complaint has been submitted successfully! An agent will contact you
                                        </p>
                                    </div>
                                </div>
                            </div>
